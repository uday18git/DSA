...
// ans special quality of the minimum number is that it is smaller than both the neighbours
...
// we can identify the unsorted part , arr[start]<=arr[mid] then left part is sorted and right part is unsorted , so we will search in right part
